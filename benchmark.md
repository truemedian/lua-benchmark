...
| Test | Code |
| ----:| ---- |
| `numeric for` | `for i = 1, 1000 do out = i end` |
| `generic for` | `for i in gen, nil, 0 do out = i end` |
| `while` | `local i = 0 while i < 1000 do i = i + 1 out = i end` |
| `repeat` | `local i = 1 repeat out = i i = i + 1 until i > 1000` |
| `goto` | `local i = 0 ::top:: i = i + 1 out = i if i < 1000 then goto top end` |
| `tailcall` | `out = tailcall(1)` |
<details>
<summary>
<b>Lua 5.1</b>
</summary>
...
| Test | Min | Median | Max | Mean | Stddev | Cost | Outliers |
| ----:|:---:|:------:|:---:|:----:|:------:|:----:|:--------:|
| `numeric for` | 2.812µs | 4.264µs | 6.577µs | 4.300µs | 510.107ns | 1.00x | 42 (0.8%) |
| `generic for` | 20.975µs | 29.930µs | 59.528µs | 30.619µs | 3.121µs | 7.02x | 45 (0.9%) |
| `while` | 5.220µs | 10.731µs | 69.751µs | 10.820µs | 1.640µs | 2.52x | 14 (0.3%) |
| `repeat` | 6.727µs | 10.247µs | 17.388µs | 10.289µs | 1.236µs | 2.40x | 45 (0.9%) |
| `goto` | - | - | - | - | - | - | - |
| `tailcall` | 13.071µs | 21.024µs | 35.577µs | 21.410µs | 2.474µs | 4.93x | 71 (1.4%) |
...
| Test | Min | Median | Max | Mean | Stddev | Cost | Outliers |
| ----:|:---:|:------:|:---:|:----:|:------:|:----:|:--------:|
| `numeric for` | 2.159µs | 5.910µs | 10.136µs | 6.035µs | 867.643ns | 1.00x | 30 (0.6%) |
| `generic for` | 24.465µs | 40.659µs | 75.411µs | 41.635µs | 4.282µs | 6.88x | 37 (0.7%) |
| `while` | 7.821µs | 13.631µs | 22.243µs | 13.886µs | 2.197µs | 2.31x | 8 (0.2%) |
| `repeat` | 7.329µs | 13.890µs | 22.755µs | 14.084µs | 1.841µs | 2.35x | 53 (1.1%) |
| `goto` | 7.679µs | 14.550µs | 23.385µs | 14.845µs | 2.227µs | 2.46x | 10 (0.2%) |
| `tailcall` | 19.204µs | 28.034µs | 55.609µs | 29.059µs | 4.062µs | 4.74x | 4 (0.1%) |
...
| Test | Min | Median | Max | Mean | Stddev | Cost | Outliers |
| ----:|:---:|:------:|:---:|:----:|:------:|:----:|:--------:|
| `numeric for` | 3.557µs | 6.285µs | 10.135µs | 6.350µs | 779.766ns | 1.00x | 59 (1.2%) |
| `generic for` | 23.461µs | 34.487µs | 119.793µs | 35.197µs | 3.520µs | 5.49x | 39 (0.8%) |
| `while` | 7.199µs | 12.243µs | 21.022µs | 12.370µs | 1.575µs | 1.95x | 58 (1.2%) |
| `repeat` | 7.380µs | 12.026µs | 19.514µs | 12.133µs | 1.500µs | 1.91x | 53 (1.1%) |
| `goto` | 7.023µs | 11.956µs | 19.001µs | 12.053µs | 1.510µs | 1.90x | 54 (1.1%) |
| `tailcall` | 15.014µs | 22.681µs | 39.626µs | 23.200µs | 2.969µs | 3.61x | 60 (1.2%) |
...
| Test | Min | Median | Max | Mean | Stddev | Cost | Outliers |
| ----:|:---:|:------:|:---:|:----:|:------:|:----:|:--------:|
| `numeric for` | 2.259µs | 3.696µs | 6.268µs | 3.742µs | 442.712ns | 1.00x | 64 (1.3%) |
| `generic for` | 12.487µs | 20.496µs | 33.343µs | 20.880µs | 2.354µs | 5.55x | 65 (1.3%) |
| `while` | 3.723µs | 7.998µs | 53.030µs | 8.091µs | 1.269µs | 2.16x | 25 (0.5%) |
| `repeat` | 4.226µs | 7.772µs | 12.450µs | 7.925µs | 964.679ns | 2.10x | 81 (1.6%) |
| `goto` | 4.917µs | 8.053µs | 12.696µs | 8.155µs | 944.851ns | 2.18x | 63 (1.3%) |
| `tailcall` | 10.105µs | 17.577µs | 28.156µs | 17.800µs | 2.006µs | 4.76x | 36 (0.7%) |
...
| Test | Min | Median | Max | Mean | Stddev | Cost | Outliers |
| ----:|:---:|:------:|:---:|:----:|:------:|:----:|:--------:|
| `numeric for` | 1.662µs | 3.546µs | 6.149µs | 3.611µs | 434.721ns | 1.00x | 71 (1.4%) |
| `generic for` | 15.401µs | 22.438µs | 37.169µs | 22.828µs | 2.805µs | 6.33x | 67 (1.3%) |
| `while` | 4.821µs | 7.596µs | 14.221µs | 7.697µs | 900.611ns | 2.14x | 57 (1.1%) |
| `repeat` | 3.741µs | 6.951µs | 11.991µs | 7.063µs | 877.715ns | 1.96x | 59 (1.2%) |
| `goto` | 4.321µs | 7.646µs | 13.284µs | 7.743µs | 910.019ns | 2.16x | 55 (1.1%) |
| `tailcall` | 10.196µs | 18.138µs | 33.771µs | 18.428µs | 2.056µs | 5.11x | 57 (1.1%) |
...
| Test | Min | Median | Max | Mean | Stddev | Cost | Outliers |
| ----:|:---:|:------:|:---:|:----:|:------:|:----:|:--------:|
| `numeric for` | 165.634ns | 265.979ns | 424.576ns | 267.542ns | 32.501ns | 1.00x | 47 (0.9%) |
| `generic for` | 647.311ns | 1.059µs | 1.811µs | 1.078µs | 149.609ns | 3.98x | 33 (0.7%) |
| `while` | 734.427ns | 1.054µs | 1.705µs | 1.063µs | 120.596ns | 3.96x | 48 (1.0%) |
| `repeat` | 615.865ns | 1.051µs | 1.776µs | 1.057µs | 123.348ns | 3.95x | 40 (0.8%) |
| `goto` | 204.822ns | 5.385µs | 9.490µs | 5.477µs | 750.201ns | 20.25x | 27 (0.5%) |
| `tailcall` | 686.694ns | 1.194µs | 1.835µs | 1.196µs | 164.782ns | 4.49x | 9 (0.2%) |
...
| Test | Min | Median | Max | Mean | Stddev | Cost | Outliers |
| ----:|:---:|:------:|:---:|:----:|:------:|:----:|:--------:|
| `numeric for` | 1.709µs | 3.117µs | 5.284µs | 3.139µs | 382.330ns | 1.00x | 53 (1.1%) |
| `generic for` | 7.822µs | 11.542µs | 19.114µs | 11.679µs | 1.353µs | 3.70x | 61 (1.2%) |
| `while` | 3.141µs | 5.174µs | 8.498µs | 5.205µs | 597.072ns | 1.66x | 48 (1.0%) |
| `repeat` | 2.814µs | 4.767µs | 9.831µs | 4.791µs | 553.774ns | 1.53x | 48 (1.0%) |
| `goto` | 3.296µs | 5.100µs | 8.650µs | 5.142µs | 585.973ns | 1.64x | 57 (1.1%) |
| `tailcall` | 8.003µs | 13.353µs | 21.188µs | 13.678µs | 2.118µs | 4.28x | 3 (0.1%) |
...
| Test | Lua 5.1 | Lua 5.2 | Lua 5.3 | Lua 5.4 | Lua 5.5 | LuaJIT | LuaJIT (Interpreter) |
| - | - | - | - | - | - | - | - |
| `numeric for` |  **4.264µs**  |  **5.910µs**  |  **6.285µs**  |  **3.696µs**  |  **3.546µs**  |  **265.979ns**  |  **3.117µs**  |
| `generic for` |  29.930µs  |  40.659µs  |  34.487µs  |  20.496µs  |  22.438µs  |  1.059µs  |  11.542µs  |
| `while` |  10.731µs  |  13.631µs  |  12.243µs  |  7.998µs  |  7.596µs  |  1.054µs  |  5.174µs  |
| `repeat` |  10.247µs  |  13.890µs  |  12.026µs  |  7.772µs  |  6.951µs  |  1.051µs  |  4.767µs  |
| `goto` |  -  |  14.550µs  |  11.956µs  |  8.053µs  |  7.646µs  |  5.385µs  |  5.100µs  |
| `tailcall` |  21.024µs  |  28.034µs  |  22.681µs  |  17.577µs  |  18.138µs  |  1.194µs  |  13.353µs  |
