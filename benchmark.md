...
| `math.pow (local)` | * | * | * | * | 0.426ns | * | 0.002ns | 1.00x | 101 (1.0%) |
| `multiply` | * | * | * | * | 0.341ns | * | 0.001ns | 1.00x | 174 (1.7%) |
| `exponent` | * | * | * | * | 0.523ns | * | 0.004ns | 1.00x | 10 (0.1%) |
...
| Test | Min | Q25 | Median | Q75 | Max | Mean | Stddev | Cost | Outliers |
| ----:|:---:|:---:|:------:|:---:|:---:|:----:|:------:|:----:|:--------:|
| `all-in-one` | * | * | * | * | 0.363ns | * | 0.001ns | 1.00x | 150 (1.5%) |
| `separated` | * | * | * | * | 0.320ns | * | 0.001ns | 1.00x | 210 (2.1%) |
| `loop` | 1.896µs | 1.989µs | 1.995µs | 2.000µs | 2.133µs | 1.995µs | 10.608ns | 6736.20x | 151 (1.5%) |
| `format` | * | * | * | * | 0.321ns | * | 0.001ns | 1.00x | 193 (1.9%) |
...
| `loop parameter` | * | 16.727ns | 17.000ns | 17.303ns | 51.563ns | 17.033ns | 0.713ns | 1.00x | 25 (0.3%) |
...
| `loop parameter` | * | 15.272ns | 15.366ns | 15.477ns | 52.753ns | 15.409ns | 0.754ns | 1.00x | 28 (0.3%) |
...
| Test | Min | Q25 | Median | Q75 | Max | Mean | Stddev | Cost | Outliers |
| ----:|:---:|:---:|:------:|:---:|:---:|:----:|:------:|:----:|:--------:|
| `argument expanision` | * | * | * | * | 0.352ns | * | 0.002ns | 1.00x | 178 (1.8%) |
| `unpack` | 10.687ns | 30.314ns | 30.365ns | 30.410ns | 77.033ns | 30.366ns | 0.636ns | 102.54x | 44 (0.4%) |
| `function` | * | * | * | * | 0.654ns | * | 0.004ns | 1.00x | 21 (0.2%) |
...
| Test | Min | Q25 | Median | Q75 | Max | Mean | Stddev | Cost | Outliers |
| ----:|:---:|:---:|:------:|:---:|:---:|:----:|:------:|:----:|:--------:|
| `literal` | * | * | * | * | 0.353ns | * | 0.002ns | 1.00x | 170 (1.7%) |
| `start empty` | 67.877ns | 107.107ns | 107.629ns | 108.051ns | 293.277ns | 107.679ns | 3.232ns | 363.47x | 23 (0.2%) |
| `start false` | * | * | * | * | 0.320ns | * | 0.001ns | 1.00x | 152 (1.5%) |
| `preallocate` | * | * | * | * | 0.571ns | * | 0.004ns | 1.00x | 24 (0.2%) |
| `ffi fill` | * | * | * | * | 0.341ns | * | 0.001ns | 1.00x | 173 (1.7%) |
| `ffi individual` | * | * | * | * | 0.750ns | * | 0.005ns | 1.00x | 11 (0.1%) |
